...
ReactDOM.createRoot(document.getElementById('root')!).render(
  <React.StrictMode>
    ...
    <h3>Change month and year and all dates selectable</h3>
    <div style={{ marginBottom: '2rem' }}>
    ...
    <h3>3 Calendars - Selectable dates</h3>
    <Calendar
      numberOfMonths={3}
    ...
    <h3>3 Calendars - Selectable date range</h3>
    <Calendar
      numberOfMonths={3}
    ...
    <h3>3 Calendars - Selectable date ranges</h3>
    <Calendar
      numberOfMonths={3}
      active={new Date(2024, 9, 1)}
      selectable={
